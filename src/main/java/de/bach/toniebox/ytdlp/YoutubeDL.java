...
import de.bach.toniebox.ytdlp.mapper.VideoFormat;
import de.bach.toniebox.ytdlp.mapper.VideoInfo;
import de.bach.toniebox.ytdlp.mapper.VideoThumbnail;
import de.bach.toniebox.ytdlp.utils.StreamGobbler;
import de.bach.toniebox.ytdlp.utils.StreamProcessExtractor;
...
public class YoutubeDL {
    ...
    protected static String command ="\"ytsearch1:";
     ...
     */
    protected static String buildCommand(String options) {
        return String.format("%s %s", executablePath ,options);
    }
